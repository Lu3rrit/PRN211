...
namespace DataAccess
{
    public class MemberDAO : BaseDAL
    {
        ...
        public IEnumerable<MemberObject> GetMembers()
        {
            ...
            string SQLSelect = "Select MemberID, Email, Password, CopanyName, City, Country from Member";
        ...
        public MemberObject GetMemberByID(int memberID)
        {
            ...
            IDataReader dataReader = null!;
            string SQLSelect = "Select MemberID, Email, Password, CopanyName, City, Country " + "from Member where MemberID = @MemberID";
            try
            {
        ...
        public MemberObject GetMemberByEmail(string email)
        {
            MemberObject member = null!;
            IDataReader dataReader = null!;
            string SQLSelect = "Select MemberID, Email, Password, CopanyName, City, Country " + "from Member where Email = @Email";
            try
            {
