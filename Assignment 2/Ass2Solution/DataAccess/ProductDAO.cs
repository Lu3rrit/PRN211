...
namespace DataAccess
{
    public class ProductDAO : BaseDAL
    {
        ...
        //-----------------
        public IEnumerable<ProductObject> GetProductByName(string name)
        {
            IDataReader dataReader = null!;
        ...
        public IEnumerable<ProductObject> GetProductByUnitPrice(decimal unitPrice)
        {
            ...
            try
            {
                var param = dataProvider.CreateParameter("@MemberID", 10, unitPrice, DbType.Decimal);
                dataReader = dataProvider.GetDataReader(SQLSelect, CommandType.Text, out connection);
                while (dataReader.Read())
                {
                    products.Add(new ProductObject
        ...
        public IEnumerable<ProductObject> GetProductByUnitInStock(int unitInStock)
        {
            ...
            try
            {
                var param = dataProvider.CreateParameter("@UnitÍnStock", 10, unitInStock, DbType.Int32);
                dataReader = dataProvider.GetDataReader(SQLSelect, CommandType.Text, out connection);
                while (dataReader.Read())
                {
                    products.Add(new ProductObject
        ...
        public ProductObject GetProductByID(int productID)
        {
            ...
            try
            {
                var param = dataProvider.CreateParameter("@MemberID", 4, productID, DbType.Int32);
